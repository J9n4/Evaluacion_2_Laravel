    ...
    <aside class="w-72 bg-gray-950 border-r border-gray-800 flex flex-col justify-between">
        <div class="p-6">
            ...
            <nav class="mt-8 space-y-1.5">
                ...
                <a href="{{ route('nt4') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-400">
                    <i class="fas fa-database text-xs"></i> NT4: Eloquent ORM
                </a>
                <a href="{{ route('nt5') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-400">
