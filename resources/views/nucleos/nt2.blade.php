...
Route::get('/dashboard', [DashboardController::class, 'index'])->middleware('auth');</code></pre>
    ...
    <div class="bg-gray-950 p-6 rounded-xl border border-gray-800">
        <h3 class="text-lg font-bold text-white mb-2"><i class="fas fa-sliders-h text-emerald-500 mr-2"></i> Simulador de Parámetros en Rutas</h3>
        <p class="text-xs text-gray-400 mb-4">Escribe un ID o un nombre en el cuadro de texto para ver cómo Laravel capturaría la variable de manera dinámica:</p>
