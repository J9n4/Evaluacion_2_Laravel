...
@section('contenido')
    ...
    <div class="mb-10">
        ...
        <div class="bg-gray-950 rounded-xl border border-gray-800 overflow-hidden text-sm">
            <pre><code class="language-bash"># Iniciar el servidor local
php artisan serve

# Crear desde composer un nuevo proyecto Laravel en la carpeta actual
...
php artisan migrate</code></pre>
    ...
    <div class="bg-gray-950 p-6 rounded-xl border border-gray-800">
        <h3 class="text-lg font-bold text-white mb-2"><i class="fas fa-folder-open text-emerald-500 mr-2"></i> Explorador del Árbol de Carpetas</h3>
        <p class="text-xs text-gray-400 mb-4">Pasa el cursor sobre las carpetas de Laravel para comprender su función en la estructura física del framework:</p>
